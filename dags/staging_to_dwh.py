...
def load_sales_fact(**context):
    ...
    query = """
        ...
        JOIN Branch_Dim b ON sb.branch = b.branch_name AND sb.city = b.city
        ...
        JOIN Time_Dim t ON st.time = t.time
...
with DAG(
    ...
    create_dwh_tables = PostgresOperator(
        ...
        sql='/opt/airflow/sql/dwh/create_dwh_tables.sql'
    )
    ...
    load_date_dim = PythonOperator(
        ...
        op_kwargs={
            ...
            'dim_table': 'Date_Dim',
            'dim_columns': ['full_date', 'day', 'month', 'year', 'weekday', 'is_weekend'],
